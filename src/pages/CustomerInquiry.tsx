          ...
          <div key={i} className={`flex align-c mt-8 mb-8`}>
            ...
            <div className="w45p pl-10 pr-10">
              <p className="text-line">
                안녕하세요~ 저 교환 신청 했었는데요..^^ 답변에 교환신청 해주신 안녕하세요~ 저 교환
                신청 했었는데요..^^ 답변에 교환신청 해주신 안녕하세요~ 저 교환 신청 했었는데요..^^
                답변에 교환신청 해주신 안녕하세요~ 저 교환 신청 했었는데요..^^ 답변에 교환신청
                해주신 안녕하세요~ 저 교환 신청 했었는데요..^^ 답변에 교환신청 해주신
              </p>
            </div>
            ...
            <div className="w10p text-center">
              <ButtonR
                ...
                onClick={() => navigate("/customer/inquiry/1234")}
              />
            </div>
          </div>
        ))}
