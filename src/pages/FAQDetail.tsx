...
import { deleteItem, moveValue, timeFormat1, timeFormat2 } from "../common/utils";
...
const FAQDetail = () => {
  ...
  const init = async () => {
    ...
    setOpeningDate(data[0]?.openingDate ? timeFormat2(data[0]?.openingDate) : "");
  ...
  const handleAddFaq = async () => {
    ...
    const postResult: any = await putUpdateData({
      collection: "faq",
      _id: faqId,
      ..._body,
    });
  ...
  return (
    <div>
      <div className="flex justify-sb align-c">
        <p className="page-title">FAQ 상세</p>
      </div>
